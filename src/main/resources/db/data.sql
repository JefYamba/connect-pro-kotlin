...
('a1b2c3d4-e5f6-7890-abcd-1234567890aa', '3a2478e6-1380-483d-897a-c400fe906769', NULL,
 ...
 '[{"insert":"Hi, I''m Jane Rivera, a passionate UI/UX Designer with 6+ years of experience creating intuitive and beautiful interfaces."},{"insert":"\n","attributes":{"header":2}},{"insert":"I specialize in turning complex problems into simple, beautiful designs that users love."},{ "insert": "\n" }]',
...
('a1b2c3d4-e5f6-7890-abcd-1234567890bb', 'fb8b5972-70ef-47bf-b02c-8a04b58f4422', NULL,
 ...
 '[{"insert":"Hello! I''m Thomas, a passionate full-stack developer who loves clean code and great user experiences."},{"insert":"\n","attributes":{"header":2}},{"insert":"I specialize in Kotlin, Spring Boot, React, and PostgreSQL."},{ "insert": "\n" }]',
...
('a1b2c3d4-e5f6-7890-abcd-1234567890cc', '0e0e1d27-7bee-4abc-9361-79cd774b9cc7', NULL,
 ...
 '[{"insert":"I help brands grow through strategic digital marketing and compelling storytelling."},{"insert":"\n"}]',
...
('a1b2c3d4-e5f6-7890-abcd-1234567890dd', 'a3053f4c-ad2c-4728-9660-bc4a3a482555', NULL,
 ...
 '[{"insert":"Product designer with a love for illustration and thoughtful user interfaces."},{"insert":"\n","attributes":{"header":2}},{"insert":"I believe great products come from deep empathy and beautiful execution."},{ "insert": "\n" }]',
...
('a1b2c3d4-e5f6-7890-abcd-1234567890ee', '64c15cb8-7551-41dd-91e6-9a3fbb6b1839', NULL,
 ...
 '[{"insert":"Senior Software Engineer focused on backend systems and developer experience."},{"insert":"\n","attributes":{"header":2}},{"insert":"I enjoy building robust systems and helping other developers grow."},{ "insert": "\n" }]',
